...
# Description: 		Each element of the result vector d is TRUE (all bits = 1) if the corresponding element of vector a is equal to the corresponding element of vector b. Otherwise
...
exit:	ori $v0, $zero, 10	# $v0 <-- function code for "exit"
	...
	#		[0]	[1]	[2]	[3]	[4]	[5]	[6]	[7]
	#	d: 	0x00,	0xFF,	0x00,	0x00,	0x00,	0xFF,	0x00,	0x00
